            ...
            <div class="basis-full md:basis-1/2">
                ...
                <div class="mt-6 flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('request.index') }}" rel="noopener"
                        class="rounded text-center transition focus-visible:ring-2 ring-offset-2 ring-gray-200 px-5 py-2.5 bg-white hover:text-teal-600 text-black flex gap-1 items-center justify-center">
