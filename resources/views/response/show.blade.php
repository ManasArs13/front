<x-app-layout>
    <div class="flex flex-col w-full mx-auto max-w-7xl p-10">
        ...
        <div class="flex flex-row mt-8 flex-nowrap">
                    ...
                    <li class="text-md my-5">
                        <div class="text-center ">
                            <form action="{{ route('response.store') }}" method="post"
                                ...
                                @csrf
                                <button type="submit" class="ml-5 text-lg block text-slate-500 hover:text-slate-800">
            ...
            <div class="basis-2/3 flex-col bg-white shadow-md rounded-md mx-4 p-4">
                <div class="p-2 flex flex-row justify-between rounded-lg bg-neutral-800">
                    <div class="basis-full rounded-lg bg-neutral-800 relative" x-data="{
                        ...
                        <h5 class="text-xl m-2 ml-3 text-slate-200" x-text="copy_text"></h5>
                        <button x-on:click="copy()" :class="copied ? 'fill-white' : 'fill-teal-300'"
                            class="flex content-center justify-center text-lg rounded-full absolute right-0 top-1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                data-slot="icon" class="w-8 h-8 m-auto fill-white hover:fill-teal-600">
                                <path fill-rule="evenodd"
                ...
                <div class="p-2 flex-col mx-auto">
                                ...
                                <div class="overflow-hidden">
                                    <div
                                        ...
                                        <form method="POST"
                                            ...
                                            <button
                                                class="w-full text-center rounded-md my-2 px-5 py-1 bg-teal-300 hover:bg-teal-400 text-black flex gap-1 items-center justify-center"
                                                type="submit">
                                                {{ __('api.save') }}
                                            </button>
                                        </form>
